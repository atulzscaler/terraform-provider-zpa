...
func dataSourcePolicyIsolation() *schema.Resource {
	return &schema.Resource{
		Read: dataSourcePolicyIsolationRead,
...
func dataSourcePolicyIsolationRead(d *schema.ResourceData, m interface{}) error {
	zClient := m.(*Client)
